...
def main():
    ...
    parser.add_argument('--no_temporal_snapshots', action='store_true',
                        help='Skip temporal snapshot creation')
    ...
    for split in ['train', 'val', 'test']:
        ...
        if not args.no_temporal_snapshots:
            ...
            print(f"  Skipping temporal snapshot creation for {split}")
            data_list = []
